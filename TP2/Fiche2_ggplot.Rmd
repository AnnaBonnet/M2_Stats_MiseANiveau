...
Reprenons le jeu de données **snore.txt** de la fiche précédente.
...
1. En utilisant la fonction **load**, charger le jeu de données Harry.Rdata qui contient le nombre d'occurrences du nom "Harry" dans chaque tome de la saga Harry Potter puis afficher les 10 premières lignes du jeu de données.
