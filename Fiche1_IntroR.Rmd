...
4. Si vous avez utilisé une boucle à la question précédente, la refaire en utilisant la fonction **apply**.
...
2. Simuler 3 trajectoires et les représenter sur le même graphique.
